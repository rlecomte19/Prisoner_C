...
/**
 * @brief Remove a client from the waiting room according to an index. Put id from this index to -1. That is to say : not anymore client here.  
 * 
 * @param room 
 * @param client_id 
 */
void remove_from_waiting_room(WaitingRoom *room, int client_id){
